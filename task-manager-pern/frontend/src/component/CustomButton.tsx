...
const CustomButton: FC<Props> = (props) => {
  ...
  const styling = {
    ...
    text: "max-w-42 py-1 px-2 rounded-lg bg-red-300 whitespace-nowrap",
    iconText: "py-1 px-2 rounded-lg flex justify-center items-center gap-3 bg-red-300 whitespace-nowrap",
  };

  return (
    <button type={type} className={`${variant && styling[variant]} m-1`}>
